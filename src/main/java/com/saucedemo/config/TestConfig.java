...
public final class TestConfig {
    ...
    public static Duration explicitWait() {
        return Duration.ofSeconds(
                Long.parseLong(value("explicitWaitSeconds", "EXPLICIT_WAIT_SECONDS", "10")));
    }

    public static String dbUrl() {
        return value("dbUrl", "DB_URL", "");
    }

    public static String dbUser() {
        return value("dbUser", "DB_USER", "");
    }

    public static String dbPassword() {
        return value("dbPassword", "DB_PASSWORD", "");
    }
    ...
    private static String value(String property, String environment, String fallback) {
        ...
        return System.getenv().getOrDefault(environment, fallback);
    }
}
